-- Update monitor_role_changes to cast arrays to jsonb
...
BEGIN
    ...
    -- Insert monitoring record with proper type casting
    INSERT INTO public.role_change_monitoring (
      ...
      to_jsonb(COALESCE(previous_roles, ARRAY[]::text[])),
      to_jsonb(COALESCE(new_roles, ARRAY[]::text[])),
