...
BEGIN
  ...
  FOR user_record IN SELECT id FROM auth.users LOOP
    -- Create sample projects for each user using valid current_phase values
    ...
    (gen_random_uuid(), 'Mobile App Development', 'Native iOS and Android app for customer service and order tracking', 'active', 'urgent', '2024-02-01', '2024-08-15', 120000, 35, 'negotiation', user_record.id, user_record.id),
    ...
    (gen_random_uuid(), 'AI Chatbot Integration', 'Implement AI-powered customer support chatbot with natural language processing', 'completed', 'low', '2023-11-01', '2024-01-31', 30000, 100, 'completion', user_record.id, user_record.id),
