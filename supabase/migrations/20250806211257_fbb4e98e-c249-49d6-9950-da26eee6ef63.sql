-- Temporarily disable triggers to avoid missing enum error
ALTER TABLE projects DISABLE TRIGGER initialize_project_lifecycle_trigger;
...
('11111111-1111-1111-1111-111111111111', '2fc4b91d-40b1-41db-ae55-460217bd36ee', 'admin', now()),
('22222222-2222-2222-2222-222222222222', '2fc4b91d-40b1-41db-ae55-460217bd36ee', 'admin', now()),
('33333333-3333-3333-3333-333333333333', '2fc4b91d-40b1-41db-ae55-460217bd36ee', 'admin', now()),
('44444444-4444-4444-4444-444444444444', '2fc4b91d-40b1-41db-ae55-460217bd36ee', 'admin', now()),
('55555555-5555-5555-5555-555555555555', '2fc4b91d-40b1-41db-ae55-460217bd36ee', 'admin', now()),
('66666666-6666-6666-6666-666666666666', '2fc4b91d-40b1-41db-ae55-460217bd36ee', 'admin', now()),
('77777777-7777-7777-7777-777777777777', '2fc4b91d-40b1-41db-ae55-460217bd36ee', 'admin', now()),
('88888888-8888-8888-8888-888888888888', '2fc4b91d-40b1-41db-ae55-460217bd36ee', 'admin', now())

ON CONFLICT (project_id, user_id) DO NOTHING;

-- Re-enable triggers
ALTER TABLE projects ENABLE TRIGGER initialize_project_lifecycle_trigger;